...
@interface CHReplyCollectionViewCell ()
...
@implementation CHReplyCollectionViewCell

- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        // Initialization interface from xib file
        NSArray *arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"CHReplyCollectionViewCell" owner:self options:nil];
        ...
        self.containerImageView.image = [[UIImage imageNamed:@"message_bubble_right"] resizableImageWithCapInsets:UIEdgeInsetsMake(15, 15, 15, 15)];
...
- (void)loadMessage:(Message *)message collectionViewWidth:(CGFloat)width {
    ...
    [self.messageLabel setPreferredMaxLayoutWidth:width - self.profieImageViewWidth.constant - kCommonMargin*3 - kTextInternalMargin - kTextInternalMargin];
